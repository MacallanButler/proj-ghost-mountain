...
import { Compass, Mountain, Quote } from "lucide-react";
...
export function CulturalSignificance() {
    return (
        <section id="culture" className="py-24 px-6 bg-gradient-to-b from-[#0e1116] via-[#11161d] to-[#0e1116] overflow-hidden">
