    ...
    return (
        <div className="min-h-screen pt-24 pb-12 px-4 bg-slate-950 text-slate-200">
            <div className="container mx-auto max-w-6xl space-y-20">
                ...
                {/* Interactive tools */}
                <section className="space-y-4">
                    <h2 className="text-2xl font-bold text-white text-center">Interactive Exhibits</h2>
                ...
                <section className="space-y-8">
                    <div className="text-center space-y-3">
                        <h2 className="text-3xl font-bold text-white">Where Your Donation Goes</h2>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[
                            ...
                            <div key={stat.label} className="p-5 bg-slate-900 rounded-xl border border-slate-800 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        {donationPrograms.map((program) => {
                            ...
                            return (
                                <div key={program.title} className="p-6 bg-slate-900/60 border border-slate-800 rounded-2xl hover:border-primary/40 transition-all space-y-3">
                    ...
                    <div className="text-center space-y-4 pt-4">
                        <p className="text-slate-400">Ready to contribute? Our secure donation form is on the homepage.</p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <a
                                ...
                                className="inline-flex items-center justify-center gap-2 px-8 py-3 border border-slate-700 text-slate-300 rounded-full font-semibold hover:border-slate-500 hover:text-white transition-all"
                            >
